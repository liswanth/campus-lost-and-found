    ...
    <section className="form-section">
      <div className="form-container">
        <div className="form-title-row">
          ...
          <div>
            <p className="section-label">LOST REPORT</p>
            <h2>Report Lost Item</h2>
            <p>Give enough detail to help someone recognize your item.</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-grid">
            <div className="field">
              ...
              <input name="itemName" placeholder="Example: Blue Wallet" value={formData.itemName} onChange={handleChange} required />
            </div>
            ...
            <div className="field">
              ...
              <input name="location" placeholder="Example: CSE Block" value={formData.location} onChange={handleChange} required />
            </div>
            ...
            <div className="field full">
              ...
              {preview && (
                <div className="image-preview">
                  <img src={preview} alt="Lost item preview" />
          ...
          <button className="submit-form-btn" type="submit" disabled={loading}>
            {loading ? 'Uploading & Saving...' : '🔍 Report Lost Item'}
          </button>
        </form>
      </div>
    </section>
